...
\section{Experience}
\cventry{2023 -- Present}{Software Engineer}{Telnyx}{Remote}{Brasil}
{
    \begin{itemize}
        \item Created RabbitMQ producers and consumers inside Python microservices on a AWS Kubernetes environment.
...
{
    \begin{itemize}
        \item Development of big data, data science applications and machine learning models using Python.
...
\cvitem{Intermediate}{C/C++, Java, TypeScript, HTML, CSS, Docker, Ansible, Lisp, AWS}
\cvitem{Advanced}{Python, C\#, Go, Shell Script, Git, GNU/Linux, Azure, Kubernetes, Terraform, Kusto}
\end{document}
