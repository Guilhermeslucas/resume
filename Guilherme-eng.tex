...
\section{Experience}
\cventry{2023 -- Present}{Software Engineer}{Telnyx}{São Paulo}{Brasil}
{
    \begin{itemize}
        \item Created RabbitMQ producers and consumers for distributed communications between microservices.
        \item Maintained modern FastAPI and legacy Python2.7 services, recording every transaction(~\$10M/monthly).
...
\cvitem{Good}{Python, C\#, Go, Shell Script, Git, GNU/Linux, Azure, Kubernetes, Terraform, Kusto}
\end{document}
