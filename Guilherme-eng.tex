...
\cventry{2024 -- Present}{Mindbody}{Senior Software Engineer, Payments}{Remote}{Brasil}
{
    \begin{itemize}
...
\cventry{2023 -- 2024}{Telnyx}{Software Engineer II, Finance Systems}{Remote}{Brasil}
{
    \begin{itemize}
...
\cventry{2021 -- 2023}{Microsoft}{Software Engineer II, Outlook Platform}{Remote}{Brasil}
{
    \begin{itemize}
...
\cventry{2019 -- 2021}{Microsoft}{Software Engineer, Commercial Software Engineering}{Remote}{Brasil}
{
    \begin{itemize}
	    \item Contributed to \textit{aks-engine}, an open-source Go project for Azure's Kubernetes Service deployments.
...
\cventry{2018 -- 2019}{Microsoft}{Software Engineering Intern, Commercial Software Engineering}{São Paulo}{Brasil}
{
    \begin{itemize}
        ...
        \item Built a TypeScript web client (Angular) for a trading platform used by thousands of traders.
	    \item Designed distributed cloud apps using Azure, Terraform, Docker, and Kubernetes.
    \end{itemize}
}

\cventry{2017 -- 2018}{CETAX}{AI Intern}{São Paulo}{Brasil}
{
    \begin{itemize}
        \item Built Big Data, Machine Learning and Artificial Inteligence applications using Python 3.
        \item Introduced and promoted a code review culture.
    \end{itemize}
}

\cventry{2015 -- 2017}{IBM}{Cloud Computing Researcher}{Campinas}{Brasil}
{
    \begin{itemize}
...
\cventry{2014 -- 2018}{Universidade Estadual de Campinas}{Computer Engineering}{Campinas}{Brasil}
{
    \begin{itemize}
